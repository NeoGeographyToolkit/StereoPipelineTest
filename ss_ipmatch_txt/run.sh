...
for method in obalog; do
    ...
    ipmatch --matches-as-txt --distance-metric $distance_metric --threads 1 ../data/left_sub16.tif run/${method}/left_sub16.vwip ../data/right_sub16.tif run/${method}/right_sub16.vwip -o run/${method}/run
done
