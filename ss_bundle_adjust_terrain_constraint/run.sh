...
bundle_adjust --solve-intrinsics ../data/left_sub16.tif ../data/right_sub16.tif ../data/left_sub16.brownconrady.tsai ../data/right_sub16.brownconrady.tsai  --create-pinhole-cameras -t pinhole --datum WGS84 -o run/run --intrinsics-to-float distortion_params --disparity-list run/run-left_sub16__right_sub1-unaligned-D.tif --max-disp-error 10 --max-iterations 5 --parameter-tolerance 1e-12 --reference-terrain run/run-DEM.tif --max-num-reference-points 1000 --threads 1
