...
# Four plain-text sub-pixel match files are the products, one per metric
# (parabola_curvature, cramer_rao, peak_ratio, snr). Each is compared against its gold copy.
