...
# Merge
sfm_merge --rig-config ../data/rig_calibrator_example_3_cameras/rig_input/rig_config.txt run/submap1.nvm run/submap2.nvm -num_image_overlaps_at_endpoints 4 -output_map run/merged.nvm -num_threads 1 --image_sensor_list ../data/rig_calibrator_example_3_cameras/rig_input/sfm_merge_image_sensor_list.txt
