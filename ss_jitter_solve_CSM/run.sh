...
# Solve for jitter. Modify the .cub files
/bin/cp -fv ../data/B17_016219_1978_XN_17N282W.8bit.cub run
/bin/cp -fv ../data/B18_016575_1978_XN_17N282W.8bit.cub run
jitter_solve --threads 1 run/B17_016219_1978_XN_17N282W.8bit.cub run/B18_016575_1978_XN_17N282W.8bit.cub run/run-B17_016219_1978_XN_17N282W.8bit.adjusted_state.json run/run-B18_016575_1978_XN_17N282W.8bit.adjusted_state.json -o run/jitter --match-files-prefix run/run --num-iterations 5 --update-isis-cubes-with-csm-state
