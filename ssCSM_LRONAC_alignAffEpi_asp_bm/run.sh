...
#stereo_gui ../data/M181058717LE.ce.crop.cub ../data/M181073012LE.ce.crop.cub run/run-DEM.tif --dem-file run/run-DEM.tif --gcp-file run/gcp3.gcp --gcp-sigma 1 run/run

parallel_stereo --left-image-crop-win 3583 3922 500 500 --right-image-crop-win 4095 4348 500 500 --threads 16 --corr-seed-mode 1 ../data/M181058717LE.ce.crop.cub ../data/M181073012LE.ce.crop.cub ../data/M181058717LE.ce.json ../data/M181073012LE.ce.json run/run --corr-tile-size 3072 --sgm-collar-size 256 --alignment-method affineepipolar --stereo-algorithm asp_bm --save-left-right-disparity-difference
