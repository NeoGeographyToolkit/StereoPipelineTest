...
sat_sim --random-pose-perturbation --camera-list ../data/dart/cam_list.txt --dem ../data/dart/SERC_DSM_WGS84.tif --horizontal-uncertainty "0 2 0" -o run/run-rand --velocity 7500
