...
# The stereo options must match run.sh exactly (asp_bm here).
stereoOpts="--alignment-method none --stereo-algorithm asp_bm --subpixel-mode 2 --corr-seed-mode 1 --min-matches 5 --ip-per-tile 2000 --mapproj-geolocation-uncertainty 0 --ip-match-radius 20"
