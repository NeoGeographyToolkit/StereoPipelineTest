...
image_align ../data/image_crop.tif ../data/image_crop_4.5pix.tif -o run/run-align.tif --output-prefix run/run --alignment-transform translation
...
image_align ../data/image_crop.tif ../data/image_crop_4.5pix.tif -o run/run-corr-align.tif --output-prefix run/run-corr \
  --disparity-params "run/run-corr-F.tif 1000000" --alignment-transform translation
