...
sat_sim --dem ../data/sat_sim_DEM.tif --ortho ../data/sat_sim_ortho.tif -o run/run --first 450 1000 10000 --last 450 1300 10000 --num 5 --first-ground-pos 450 1000 --last-ground-pos 450 1300 --roll 0 --pitch 40 --yaw 0 --sensor-type linescan --velocity 7000 --horizontal-uncertainty '0 0 0' --rig ../data/sim_rig_linescan.txt
...
ls run/run_c1.json > run/list.txt
