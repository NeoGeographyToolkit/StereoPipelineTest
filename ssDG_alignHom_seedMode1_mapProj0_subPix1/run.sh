...
stereo --enable-fill-holes ../data/WV01_11JAN131652275-P1BS-10200100104A0300.r12_crop.tif ../data/WV01_11JAN131653225-P1BS-1020010011862E00.r12_crop.tif ../data/WV01_11JAN131652275-P1BS-10200100104A0300.r12.xml ../data/WV01_11JAN131653225-P1BS-1020010011862E00.r12.xml run/run --stereo-file stereo.default -t dg --alignment-method homography --corr-seed-mode 1 --subpixel-mode 1 --bundle-adjust-prefix ../data/run_dg_ba/run --left-image-crop-win 1013 503 700 8403 --right-image-crop-win 1413 603 832 534 --min-num-ip 10
