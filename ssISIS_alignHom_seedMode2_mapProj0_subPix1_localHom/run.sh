...
rm -rfv run
# Multiview 
stereo --enable-fill-holes ../data/M0100115_crop.cub ../data/E0201461.cub ../data/E0201461_copy.cub run/run -s stereo.default --left-image-crop-win 0 1024 672 1200  --disparity-estimation-dem ../data/ref-DEM.tif --disparity-estimation-dem-error 5 --alignment-method homography --corr-seed-mode 2 --subpixel-mode 1 --use-local-homography
